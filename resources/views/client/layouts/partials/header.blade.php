        ...
        <div class="row menu-center align-items-center justify-content-between">
            ...
            <div class="col mt-15 mb-15">
                ...
                <div class="header-logo">
                    <a href="index.html">
                        <img src="/jadusona/assets/images/logo.png" alt="Jadusona">
                    </a>
                </div><!-- Logo End -->
            </div>
            ...
            <div class="col order-2 order-lg-3">
                ...
                <div class="header-shop-links">
                    ...
                    <div class="header-search">
                        <button class="search-toggle"><img src="/jadusona/assets/images/icons/search.png"
                                alt="Search Toggle"><img class="toggle-close"
                                src="/jadusona/assets/images/icons/close.png" alt="Search Toggle"></button>
                        <div class="header-search-wrap">
                            <form action="#">
                                <input type="text" placeholder="Type and hit enter">
                                <button><img src="/jadusona/assets/images/icons/search.png"
                                        alt="Search"></button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="header-wishlist">
                        <a href="wishlist.html"><img src="/jadusona/assets/images/icons/wishlist.png"
                                alt="Wishlist"> <span>02</span></a>
                    </div>

                    <div class="header-mini-cart">
                        <a href="cart.html"><img src="/jadusona/assets/images/icons/cart.png"
                                alt="Cart"> <span>02($250)</span></a>
                    </div>
